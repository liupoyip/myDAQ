...
class Ui_NI9234(object):
    def setupUi(self, NI9234):
        ...
        self.ImportConfig_GroupBox = QGroupBox(NI9234)
        self.ImportConfig_GroupBox.setObjectName(u"ImportConfig_GroupBox")
        self.ImportConfig_GroupBox.setGeometry(QRect(20, 30, 341, 51))
        self.ImportConfig_Pushbutton = QPushButton(self.ImportConfig_GroupBox)
        self.ImportConfig_Pushbutton.setObjectName(u"ImportConfig_Pushbutton")
        self.ImportConfig_Pushbutton.setGeometry(QRect(280, 20, 51, 24))
        self.ImportConfigPath_LineEdit = QLineEdit(self.ImportConfig_GroupBox)
        self.ImportConfigPath_LineEdit.setObjectName(u"ImportConfigPath_LineEdit")
        self.ImportConfigPath_LineEdit.setEnabled(False)
        self.ImportConfigPath_LineEdit.setGeometry(QRect(80, 20, 191, 22))
        self.ImportConfig_Label = QLabel(self.ImportConfig_GroupBox)
        self.ImportConfig_Label.setObjectName(u"ImportConfig_Label")
        self.ImportConfig_Label.setGeometry(QRect(10, 20, 61, 16))
    ...
    def retranslateUi(self, NI9234):
        ...
        self.ImportConfig_GroupBox.setTitle(QCoreApplication.translate("NI9234", u"Task Config", None))
        self.ImportConfig_Pushbutton.setText(QCoreApplication.translate("NI9234", u"Import", None))
        self.ImportConfig_Label.setText(QCoreApplication.translate("NI9234", u"config path", None))
    # retranslateUi
